...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Harold Moncada
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Engineering student</h3>
            <p className="home__description">Hello! I'm Harold, a student at the Technical University of Oruro (UTO), Faculty of Engineering. I'm passionate about mobile application development and am currently working on a multi-vendor e-commerce app using Flutter and Firebase. I am committed to technology and continually seek opportunities to learn and grow in the field of software development.</p>
